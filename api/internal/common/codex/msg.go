...
var codeMsgMap = map[ResCode]string{
	...
	CodeUploadProjectErr:        "上传项目错误",
	CodeQueryProjectErr:         "查询项目出错",
	CodeQueryProjectLanguageErr: "查询项目语言出错",
	CodeQueryProjectTagErr:      "查询项目标签错误",
	CodeQueryProjectMasterErr:   "查询项目主人错误",
	CodeQuerySchoolErr:          "查询学校失败",
}
